...
class DS3231(GenericSensor):
	...
	def ReadData(self, pData):
        ...
        def __init__(self, pAddr, pLabel = "DS3231", pCentury = 21):
                readings = \
                [
                        Reading("Seconds", 	"sec",		Register = 0x00, Min = 0, Max = 59),
			Reading("Minutes", 	"min",		Register = 0x01, Min = 0, Max = 59),
			Reading("Hours", 	"hours",	Register = 0x02, Min = 0, Max = 23),
			Reading("Day", 		" ",		Register = 0x04, Min = 1, Max = 31),
			Reading("Date", 	" ",		Register = 0xFF, Min = 0, Max = 0),
			Reading("Month", 	"months",	Register = 0x05, Min = 1, Max = 12),
			Reading("Year", 	" ",		Register = 0x06, Min = 0, Max = 99),
